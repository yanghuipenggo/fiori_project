sap.ui.define([
    ...
    function journey() {
        ...
        opaTest("Start application", function (Given, When, Then) {
            ...
            Then.onTheTravelList.onTable().iCheckColumns(5, {"TravelID":{"header":"Travel ID"},"AgencyID":{"header":"Agency ID"},"AgencyName":{"header":"Agency Name"},"CustomerID":{"header":"Customer ID"},"CustomerName":{"header":"Last Name"}});
